...
struct AnomalieUpdateFormView: View {
...
struct AnomalieUpdateFormView_Previews: PreviewProvider {
    static var previews: some View {
        AnomalieUpdateFormView(anomalie: sampleAnomalie1)
    }
}
